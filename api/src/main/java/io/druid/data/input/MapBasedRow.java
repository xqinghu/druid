...
public class MapBasedRow implements Row
{
  ...
  {
    return Rows.objectToNumber(metric, event.get(metric)).longValue();
  }

  @Override
  public double getDoubleMetric(final String metric)
  {
    return Rows.objectToNumber(metric, event.get(metric)).doubleValue();
  }

  @Override
  public float getFloatMetric(String metric)
  {
    return Rows.objectToNumber(metric, event.get(metric)).floatValue();
  }
