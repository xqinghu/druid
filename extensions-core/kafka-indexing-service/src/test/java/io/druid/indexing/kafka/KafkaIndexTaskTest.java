...
public class KafkaIndexTaskTest
{
  ...
  public void testMultipleParseExceptionsSuccess() throws Exception
  {
    ...
    // Check metrics
    Assert.assertEquals(7, task.getFireDepartmentMetrics().processed());
    Assert.assertEquals(6, task.getFireDepartmentMetrics().unparseable());
    Assert.assertEquals(1, task.getFireDepartmentMetrics().thrownAway());
    ...
    expectedMetrics.put(TaskMetricsUtils.ROWS_PROCESSED, 7L);
    expectedMetrics.put(TaskMetricsUtils.ROWS_UNPARSEABLE, 6L);
    expectedMetrics.put(TaskMetricsUtils.ROWS_THROWN_AWAY, 1L);
  ...
  public void testMultipleParseExceptionsFailure() throws Exception
  {
    ...
    Assert.assertEquals("Unable to parse row [unparseable2]", status.getErrorMsg());
    ...
    expectedMetrics.put(TaskMetricsUtils.ROWS_THROWN_AWAY, 0L);
    Assert.assertEquals(expectedMetrics, status.getMetrics());
