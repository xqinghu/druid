...
public class IndexTaskTest
{
  ...
  public void testMultipleParseExceptionsSuccess() throws Exception
  {
    ...
    try (BufferedWriter writer = Files.newWriter(tmpFile, StandardCharsets.UTF_8)) {
      ...
      writer.write("2014-01-01T00:00:10Z,b,2,4.0,notanumber\n"); // row with invalid metric
    ...
    expectedMetrics.put(TaskMetricsUtils.ROWS_PROCESSED, 4L);
    expectedMetrics.put(TaskMetricsUtils.ROWS_UNPARSEABLE, 6L);
    ...
    List<String> expectedUnparseableEvents = Arrays.asList(
        ...
        "Found unparseable columns in row: [MapBasedInputRow{timestamp=2014-01-01T00:00:10.000Z, event={time=2014-01-01T00:00:10Z, dim=b, dimLong=2, dimFloat=4.0, val=notanumber}, dimensions=[dim, dimLong, dimFloat]}], exceptions: [Unable to parse value[notanumber] for field[val],]",
  ...
  public void testMultipleParseExceptionsFailure() throws Exception
  {
    ...
    Map<String, Object> expectedMetrics = Maps.newHashMap();
    expectedMetrics.put(TaskMetricsUtils.ROWS_PROCESSED, 1L);
