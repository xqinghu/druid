...
public class Transformer
{
  ...
  public static class TransformedInputRow implements InputRow
  {
    ...
    public float getFloatMetric(final String metric)
    {
      ...
      if (transform != null) {
        return Rows.objectToNumber(metric, transform.eval(row)).floatValue();
      } else {
    ...
    public long getLongMetric(final String metric)
    {
      final RowFunction transform = transforms.get(metric);
      if (transform != null) {
        return Rows.objectToNumber(metric, transform.eval(row)).longValue();
      } else {
    ...
    public double getDoubleMetric(final String metric)
    {
      final RowFunction transform = transforms.get(metric);
      if (transform != null) {
        return Rows.objectToNumber(metric, transform.eval(row)).doubleValue();
      } else {
