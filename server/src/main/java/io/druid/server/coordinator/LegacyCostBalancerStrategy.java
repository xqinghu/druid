...
public class LegacyCostBalancerStrategy implements BalancerStrategy
{
  ...
  public LegacyCostBalancerStrategy(final ListeningExecutorService exec)
  {
    this.exec = exec;
  }
  ...
  public double computeJointSegmentCosts(final DataSegment segment1, final DataSegment segment2)
  {
    ...
    final double cost = baseCost * dataSourcePenalty * gapPenalty;
