...
public class AuthorizationStorageConnectorConfig
{
  @JsonProperty
  ...
  {
    if (connectURI == null) {
      return String.format("jdbc:derby://%s:%s/druid_auth;create=true", host, port);
    }
    return connectURI;
  }
  ...
  public boolean equals(Object o)
  {
    ...
    if (!(o instanceof AuthorizationStorageConnectorConfig)) {
      return false;
    }

    AuthorizationStorageConnectorConfig that = (AuthorizationStorageConnectorConfig) o;
