...
public class CreateAuthorizationTables extends GuiceRunnable
{
  ...
  private void setupInternalDruidSystemUser(SecurityStorageConnector dbConnector, ObjectMapper jsonMapper)
  {
    if (systemUser == null) {
  ...
  private void setupDefaultAdmin(SecurityStorageConnector dbConnector, ObjectMapper jsonMapper)
  {
    if (adminUser == null) {
