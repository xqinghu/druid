...
{
  private static final TimeExtractSqlFunction CALCITE_OPERATOR = new TimeExtractSqlFunction();
  ...
  private static class TimeExtractSqlFunction extends SqlFunction
  {
    TimeExtractSqlFunction()
    {
      super(
          "TIME_EXTRACT",
