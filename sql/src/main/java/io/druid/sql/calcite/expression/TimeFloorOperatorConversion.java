...
{
  private static final TimeFloorSqlFunction CALCITE_OPERATOR = new TimeFloorSqlFunction();
  ...
  private static class TimeFloorSqlFunction extends SqlFunction
  {
    TimeFloorSqlFunction()
    {
      super(
          "TIME_FLOOR",
