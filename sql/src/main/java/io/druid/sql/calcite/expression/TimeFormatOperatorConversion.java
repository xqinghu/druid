...
{
  private static final TimeFormatSqlFunction CALCITE_OPERATOR = new TimeFormatSqlFunction();
  ...
  private static class TimeFormatSqlFunction extends SqlFunction
  {
    TimeFormatSqlFunction()
    {
      super(
          "TIME_FORMAT",
