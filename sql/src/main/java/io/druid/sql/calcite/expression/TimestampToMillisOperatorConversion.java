...
{
  private static final String NAME = "TIMESTAMP_TO_MILLIS";
  private static final TimestampToMillisOperator OPERATOR = new TimestampToMillisOperator();
  ...
  private static class TimestampToMillisOperator extends SqlFunction
  {
    TimestampToMillisOperator()
    {
      super(
          NAME,
